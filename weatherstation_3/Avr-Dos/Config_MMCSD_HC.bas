...
Const Cmmc_soft = 0
 ...
 ' --------- Start of Section for HW-SPI ----------------------------------------
   ...
   ' define Chip-Select Pin
      Config Portd.4 = Output                                  ' define here Pin for CS of MMC/SD Card
      Mmc_cs Alias Portd.4
      Set Mmc_cs

   ' Define here SS Pin of HW-SPI of the CPU (f.e. Pinb.0 on M128)
      Config Portd.4 = Output                                  ' define here Pin of SPI SS
...
#endif
   ' define Chip-Select Pin
 '  Config Pinf.7 = Output                                   ' define here Pin for CS External serial Flash
 '  Mmc_cs Alias Portf.7
 '  Set Mmc_cs
'(
